...
def run_damage_test():
    ...
    print('  - test_results/damage/damage_test_1.png')
    print('  - test_results/damage/damage_test_2.png')
    print('  - test_results/damage/damage_test_3.png')
    print('  - test_results/damage/damage_test_4.png')
