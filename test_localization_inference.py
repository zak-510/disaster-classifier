...
def run_localization_test():
    ...
    if model is None:
        ...
        # Select 4 test images - positions 1&3 have severe damage, diverse disaster types
    test_images = [
        'palu-tsunami_00000181',      # 392 damaged buildings (357 destroyed!)
        'hurricane-michael_00000366', # Original position 2
        'santa-rosa-wildfire_00000089', # 171 damaged buildings (170 destroyed!)
        'hurricane-florence_00000013' # Original position 4
    ]
    
    print(f'Processing {len(test_images)} test images...')
    
    for i, image_id in enumerate(test_images, 1):
        print(f'\nProcessing image {i}/4: {image_id}')
    ...
    print('  - test_results/localization/localization_test_1.png')
    print('  - test_results/localization/localization_test_2.png') 
    print('  - test_results/localization/localization_test_3.png')
    print('  - test_results/localization/localization_test_4.png')
